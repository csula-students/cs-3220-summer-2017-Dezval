...
public class RandomRestaurantListServlet extends HttpServlet {
    ...
    public void init(){
        ...
        addRestaurantsToList(R_entries);
//        R_entries.add(new Restaurant(R_entries.size(), "Apple Restaurant", "URL"));
//        R_entries.add(new Restaurant(R_entries.size(), "Pumpkin Restaurant", "URL"));
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Restaurant entry: R_entries){
            out.println(
                    "<tr>" +
                            "<td>" + entry.getName() + "</td>" +
