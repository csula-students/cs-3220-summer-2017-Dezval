...
public class RandomRestaurantServlet extends HttpServlet {
    ...
    public void init(){
//        List<Restaurant> R_entries = new ArrayList<>();
//        R_entries.add(new Restaurant(R_entries.size(), "Apple pie", "description TBA"));
//        R_entries.add(new Restaurant(R_entries.size(), "Pumpkin Pie", "description TBA"));
//        getServletContext().setAttribute("R_entries", R_entries);
    }
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<Restaurant> R_entries = (List<Restaurant>) getServletContext().getAttribute("R_entries");
        getServletContext().setAttribute("R_entries", R_entries);
        response.setContentType("text/html");
        PrintWriter out = response.getWriter();

        tempRestaurant = getRandomRestaurant(R_entries);
...
//        List<Restaurant> R_entries = (List<Restaurant>) getServletContext().getAttribute("entries");
//        R_entries.get(tempRestaurant.getId()).addDesignRating(Integer.valueOf(request.getParameter("designRate")));
//        R_entries.get(tempRestaurant.getId()).addTasteRating(Integer.valueOf(request.getParameter("tasteRate")));
////        getServletContext().setAttribute("entries", R_entries);
//
